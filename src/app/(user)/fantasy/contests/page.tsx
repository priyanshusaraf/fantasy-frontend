...
export default function ContestsPage() {
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8 text-[#5b62b3]">
        Fantasy Pickleball Contests
      </h1>

      <div className="mb-12">
        <h2 className="text-2xl font-semibold mb-4 text-[#00a1e0]">
          How It Works
        </h2>

        <div className="bg-[#fff5fc] shadow rounded-lg p-6 mb-6">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="flex flex-col items-center text-center">
              <div className="bg-[#6da0e1]/20 text-[#00a1e0] rounded-full w-12 h-12 flex items-center justify-center mb-4">
                <span className="font-bold text-lg">1</span>
              </div>
              <h3 className="font-bold text-lg mb-2 text-[#5b62b3]">
                Join a Contest
              </h3>
              <p className="text-[#5b62b3]/70">
        ...
        <div className="bg-[#dec2db]/20 border-l-4 border-[#dec2db] p-4 mb-6">
          <div className="flex">
            <div className="flex-shrink-0">
              <svg
                className="h-5 w-5 text-[#5b62b3]"
                viewBox="0 0 20 20"
                fill="currentColor"
              >
                <path
            ...
            <div className="ml-3">
              <p className="text-sm text-[#5b62b3]">
      ...
      <div className="mb-12">
        <div className="bg-[#fff5fc] shadow rounded-lg overflow-hidden mb-8">
          <div className="bg-gradient-to-r from-[#6da0e1] to-[#00a1e0] px-6 py-4">
      ...
      <div>
        <h2 className="text-2xl font-semibold mb-6 text-[#5b62b3]">
          All Contests
        </h2>
