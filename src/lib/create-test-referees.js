...
async function createTestReferees() {
  ...
  try {
    // Create test users
    const users = [
      { username: 'referee1', email: 'referee1@example.com', role: 'REFEREE' },
      { username: 'referee2', email: 'referee2@example.com', role: 'REFEREE' },
      { username: 'referee3', email: 'referee3@example.com', role: 'REFEREE' },
    ];
